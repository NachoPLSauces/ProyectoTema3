		...
		<main>
                    <div class="contenido">
                        <table>
                            ...
                            <tr>
                                <td>1. Inicializar variables de los distintos tipos de datos básicos(string, int, float, bool) y mostrar los datos por pantalla (echo, print, printf, print_r,var_dump).</td>
                            ...
                            <tr>
                                <td>3. Mostrar en tu página index la fecha y hora actual formateada en castellano</td>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio12.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio14.php">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>15. Crear e inicializar un array con el sueldo percibido de lunes a domingo. Recorrer el array para calcular el sueldo percibido durante lasemana. (Array asociativo con los nombres de los días de la semana).</td>
                                <td><a href="codigoPHP/ejercicio15.php">Ejecutar</a></td>
                                <td><a href="mostrarcodigo/muestraEjercicio15.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio16.php">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>17. Inicializar un array (bidimensional con dos índices numéricos) donde almacenamos el nombre de las personas que tienen reservado el asiento en un teatro de 20 filas y 15 asientos por fila. (Inicializamos el array ocupando únicamente 5 asientos). Recorrer el array condistintas técnicas (foreach(), while(), for()) para mostrar los asientos ocupados en cada fila y las personas que lo ocupan.</td>
                                <td><a href="codigoPHP/ejercicio17.php">Ejecutar</a></td>
                                <td><a href="mostrarcodigo/muestraEjercicio17.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio19.php">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>20. Convertir la LibreriaValidacionFormularios.php en una clase ValidacionFormularios.php. El profesor facilitará a los alumnos la claseAAMMDDValidacionFormularios.php desarrollada en el curso anterior como punto de partida.</td>
                                <td><a href="codigoPHP/ejercicio20.php">Ejecutar</a></td>
                                <td><a href="mostrarcodigo/muestraEjercicio20.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio21.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio22.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio23.php">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>24. Construir un formulario para recoger un cuestionario realizado a una persona y mostrar en la  misma página las preguntas y las respuestasrecogidas; en el caso de que alguna respuesta esté vacía o errónea volverá a salir el formulario con el mensaje correspondiente, pero lasrespuestas que habíamos tecleado correctamente aparecerán en el formulario y no tendremos que volver a teclearlas.</td>
                                <td><a href="codigoPHP/ejercicio24.php">Ejecutar</a></td>
                                <td><a href="mostrarcodigo/muestraEjercicio24.php">Inspeccionar</a></td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td><a href="mostrarcodigo/muestraEjercicio25.php">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>27.(Aplicación de recogida de datos y análisis de resultados) podamos utilizar para recoger las respuestas auna encuesta de varias preguntas realizada a 3-5 personas, el usuario de la página web tecleará lasrespuestas y recibirá como respuesta un resumen con algún tipo de calculo, resumen o tratamiento sobrelas respuestas a al encuesta.Entre las respuestas tienen que haber, respuestas textuales, respuestas si/no, fechas, números enteros,números decimales,...</td>
                                <td><a href="#" style="color:red">Ejecutar</a></td>
                                <td><a href="#" style="color:red">Inspeccionar</a></td>
                            </tr>
                            
                            <tr>
                                <td>28. Encuesta de satisfacción utilizando una plantilla</td>
                                <td><a href="codigoPHP/ejercicio28.php">Ejecutar</a></td>
                                <td><a href="mostrarcodigo/muestraEjercicio28.php">Inspeccionar</a></td>
                            </tr>
                        </table>
                    </div>
                    <br>
